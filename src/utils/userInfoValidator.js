class Validator {
    ...
    static _correct_news_api_topics = ["business","entertainment","general","health","science","sports","technology"]
    
    static _correct_news_api_countries = ["ae","ar","at","au","be","bg","br","ca","ch","cn","co","cu","cz","de","eg","fr",
    ...
    static validateTopic(topic) {
        return this._correct_news_api_topics.includes(topic);
    }

    static validateCountry(country) {
        return this._correct_news_api_countries.includes(country);
    }
